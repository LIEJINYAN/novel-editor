...
const DEFAULT_SHORTCUTS: ShortcutDef[] = [
  ...
  { id: 'tab1', label: '切换标签1', key: '1', ctrl: true, code: 'Ctrl+1' },
  { id: 'tab2', label: '切换标签2', key: '2', ctrl: true, code: 'Ctrl+2' },
  { id: 'tab3', label: '切换标签3', key: '3', ctrl: true, code: 'Ctrl+3' },
  { id: 'tab4', label: '切换标签4', key: '4', ctrl: true, code: 'Ctrl+4' },
  { id: 'tab5', label: '切换标签5', key: '5', ctrl: true, code: 'Ctrl+5' },
  { id: 'tab6', label: '切换标签6', key: '6', ctrl: true, code: 'Ctrl+6' },
  { id: 'tab7', label: '切换标签7', key: '7', ctrl: true, code: 'Ctrl+7' },
  { id: 'tab8', label: '切换标签8', key: '8', ctrl: true, code: 'Ctrl+8' },
  { id: 'tab9', label: '切换标签9', key: '9', ctrl: true, code: 'Ctrl+9' },
